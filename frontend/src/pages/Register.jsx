...
import { User, Mail, Lock, Eye, EyeOff, Loader2, Sparkles, AlertCircle, CheckCircle2, Wallet } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden font-sans">
      ...
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-slate-200/50 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-[#F1F5F9] border border-[#E2E8F0] text-[#475569] text-xs font-semibold tracking-wide uppercase">
            ...
            <span>Join SpendWise AI</span>
          </div>
          <h2 className="text-3xl font-extrabold tracking-tight text-[#0F172A] sm:text-4xl">
            Create your account
          </h2>
          <p className="text-sm font-medium text-[#64748B]">
            Start managing smart finances with AI insights in seconds.
          </p>
        </div>
        ...
        <div className="bg-white border border-[#E2E8F0] p-8 rounded-2xl shadow-sm space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3 bg-white border ${
                    errors.name ? 'border-rose-500' : 'border-[#CBD5E1] focus:border-[#111827]'
              ...
              {errors.name && (
                <p className="text-xs font-medium text-rose-500 mt-1">{errors.name}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-11 py-3 bg-white border ${
                    errors.confirmPassword ? 'border-rose-500' : 'border-[#CBD5E1] focus:border-[#111827]'
                  } rounded-xl text-[#0F172A] font-semibold placeholder-[#94A3B8] text-sm focus:outline-none focus:ring-2 focus:ring-[#111827]/10 transition-all`}
                />
                <button
                  type="button"
              ...
              {errors.confirmPassword && (
                <p className="text-xs font-medium text-rose-500 mt-1">{errors.confirmPassword}</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-3.5 px-4 bg-[#111827] hover:bg-[#1F2937] text-white font-semibold rounded-xl text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-[#111827]/30 disabled:opacity-60 disabled:cursor-not-allowed transition-all flex justify-center items-center space-x-2 cursor-pointer"
            >
              {loading ? (
                <>
