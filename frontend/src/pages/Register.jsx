...
import { User, Mail, Lock, Eye, EyeOff, Loader2, Sparkles, AlertCircle, CheckCircle2 } from 'lucide-react';
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3 bg-slate-950/70 border ${
                    errors.name ? 'border-rose-500/60' : 'border-slate-800 focus:border-red-500'
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-11 py-3 bg-slate-950/70 border ${
                    errors.confirmPassword ? 'border-rose-500/60' : 'border-slate-800 focus:border-red-500'
                  } rounded-xl text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-all`}
                />
                <button
                  type="button"
